...
function login(req, res) {
  ...
  _migration2.default.query(query).then(function (user) {
    ...
    return res.status(200).json({ foundUser: foundUser, token: token });
  }).catch(function (err) {
    res.status(500).json(err);
  });
}
...
exports.default = {
  addUser: addUser, login: login, getAllUsers: getAllUsers, getUser: getUser, updateUser: updateUser, deleteUser: deleteUser
};
